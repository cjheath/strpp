...
compiler_test	compiler_tests[] =
{
 ...
 { 0,	"--- Escapes; also check simple repetitions of them ---", 0 },
	...
	{ "ab\\f?",	"\x01\x0E\x01\x02\x02\x61\x62\x09\x01\x02\x02\x01\x0C\x0F\x10", 0 },
	{ "ab\\f*",	"\x01\x0E\x01\x02\x02\x61\x62\x09\x01\x01\x02\x01\x0C\x0F\x10", 0 },
	{ "ab\\f+",	"\x01\x0E\x01\x02\x02\x61\x62\x09\x02\x01\x02\x01\x0C\x0F\x10", 0 },
 { 0,	"--- Octal character escapes ---", 0 },
	...
	{ "\\077*",	"\x01\x0A\x01\x09\x01\x01\x02\x01\x3F\x0F\x10", 0 },
 { 0,	"--- Hex character escapes ---", 0 },
	...
	{ "\\x77*",	"\x01\x0A\x01\x09\x01\x01\x02\x01\x77\x0F\x10", 0 },
 { 0,	"--- Unicode escapes ---", 0 },
	...
	{ "\\u77*",	"\x01\x0A\x01\x09\x01\x01\x02\x01\x77\x0F\x10", 0 },
 { 0,	"--- Character properties: ---", 0 },
	{ "\\sA",	"\x01\x09\x01\x03\x01\x20\x02\x01\x41\x10", 0 },
	{ "a\\s*",	"\x01\x0D\x01\x02\x01\x61\x09\x01\x01\x03\x01\x20\x0F\x10", 0 },
	{ "\\p{foo}A",	"\x01\x0B\x01\x03\x03\x66\x6F\x6F\x02\x01\x41\x10", 0 },
	{ "a\\p{foo}*",	"\x01\x0F\x01\x02\x01\x61\x09\x01\x01\x03\x03\x66\x6F\x6F\x0F\x10", 0 },
 { 0,	"--- Anchors ---", 0 },
 ...
 { 0,	"--- Any ---", 0 },
	...
	{ ".*",	"\x01\x08\x01\x09\x01\x01\x08\x0F\x10", 0 },
	{ ".+",	"\x01\x08\x01\x09\x02\x01\x08\x0F\x10", 0 },
	{ ".{2,5}",	"\x01\x08\x01\x09\x03\x06\x08\x0F\x10", 0 },
 ...
 { 0,	"--- Alternates ---", 0 },
	{ "a|b",	"\x01\x0D\x01\x11\x05\x02\x01\x61\x0D\x05\x02\x01\x62\x10", 0 },
	{ "a|b|c",	"\x01\x12\x01\x11\x05\x02\x01\x61\x0D\x05\x02\x01\x62\x0D\x05\x02\x01\x63\x10", 0 },
	{ "a|b|cde|f",	"\x01\x19\x01\x11\x05\x02\x01\x61\x0D\x05\x02\x01\x62\x0D\x07\x02\x03\x63\x64\x65\x0D\x05\x02\x01\x66\x10", 0 },
	{ "(a|b)(c)",	"\x01\x16\x01\x0A\x0C\x11\x05\x02\x01\x61\x0D\x05\x02\x01\x62\x0F\x0A\x05\x02\x01\x63\x0F\x10", 0 },
	{ "(a|b|c)(d)",	"\x01\x1B\x01\x0A\x11\x11\x05\x02\x01\x61\x0D\x05\x02\x01\x62\x0D\x05\x02\x01\x63\x0F\x0A\x05\x02\x01\x64\x0F\x10", 0 },
	{ "(a|b)|(c)",	"\x01\x1A\x01\x11\x0F\x0A\x0C\x11\x05\x02\x01\x61\x0D\x05\x02\x01\x62\x0F\x0D\x08\x0A\x05\x02\x01\x63\x0F\x10", 0 },
 { 0,	"--- Long offsets ---", 0 },
 ...
 { 0,	"--- Repetition: ---", 0 },
	{ "a?",	"\x01\x0A\x01\x09\x01\x02\x02\x01\x61\x0F\x10", 0 },
	{ "a*",	"\x01\x0A\x01\x09\x01\x01\x02\x01\x61\x0F\x10", 0 },
	{ "a+",	"\x01\x0A\x01\x09\x02\x01\x02\x01\x61\x0F\x10", 0 },
	{ "abc?",	"\x01\x0E\x01\x02\x02\x61\x62\x09\x01\x02\x02\x01\x63\x0F\x10", 0 },
	{ "abc*",	"\x01\x0E\x01\x02\x02\x61\x62\x09\x01\x01\x02\x01\x63\x0F\x10", 0 },
	{ "abc+",	"\x01\x0E\x01\x02\x02\x61\x62\x09\x02\x01\x02\x01\x63\x0F\x10", 0 },
	{ "?",	0, "Repeating a repetition is disallowed" },
	{ "*",	0, "Repeating a repetition is disallowed" },
	{ "+",	0, "Repeating a repetition is disallowed" },
	{ "abc*+def",	0, "Repeating a repetition is disallowed" },
	{ "(abc)?",	"\x01\x0F\x01\x09\x01\x02\x0A\x07\x02\x03\x61\x62\x63\x0F\x0F\x10", 0 },
	{ "(abc)??",	0, "Repeating a repetition is disallowed" },
	{ "(abc)?+",	0, "Repeating a repetition is disallowed" },
	{ "(abc)?*",	0, "Repeating a repetition is disallowed" },
	{ "(abc)*",	"\x01\x0F\x01\x09\x01\x01\x0A\x07\x02\x03\x61\x62\x63\x0F\x0F\x10", 0 },
	{ "(a|b)*?",	0, "Repeating a repetition is disallowed" },
	{ "(abc)**",	0, "Repeating a repetition is disallowed" },
	{ "(a|b)*+",	0, "Repeating a repetition is disallowed" },
	{ "(abc)+",	"\x01\x0F\x01\x09\x02\x01\x0A\x07\x02\x03\x61\x62\x63\x0F\x0F\x10", 0 },
	{ "(a|b)+?",	0, "Repeating a repetition is disallowed" },
	{ "(a|b)+*",	0, "Repeating a repetition is disallowed" },
	{ "(a|b)++",	0, "Repeating a repetition is disallowed" },
	{ "(a|b?|c*|d+)*",	"\x01\x2A\x01\x09\x01\x01\x0A\x22\x11\x05\x02\x01\x61\x0D\x09\x09\x01\x02\x02\x01\x62\x0F\x0D\x09\x09\x01\x01\x02\x01\x63\x0F\x0D\x09\x09\x02\x01\x02\x01\x64\x0F\x0F\x0F\x10", 0 },
 { 0,	"--- Repetition ranges ---", 0 },
	{ "a{2,3}",	"\x01\x0A\x01\x09\x03\x04\x02\x01\x61\x0F\x10", 0 },
	{ "a{ 2 , 3 }",	"\x01\x0A\x01\x09\x03\x04\x02\x01\x61\x0F\x10", 0 },
	{ "a{2,}",	"\x01\x0A\x01\x09\x03\x01\x02\x01\x61\x0F\x10", 0 },
	{ "a{2,	}",	"\x01\x0A\x01\x09\x03\x01\x02\x01\x61\x0F\x10", 0 },
	{ "a{,3}",	"\x01\x0A\x01\x09\x01\x04\x02\x01\x61\x0F\x10", 0 },
	{ "a{ ,3}",	"\x01\x0A\x01\x09\x01\x04\x02\x01\x61\x0F\x10", 0 },
	{ "a{254,254}",	"\x01\x0A\x01\x09\xFF\xFF\x02\x01\x61\x0F\x10", 0 },
 ...
 { 0,	"--- Named groups ---", 0 },
	...
	{ "(?<foo>a|b?|c*|d+){2,5}",	"\x01\x2F\x02\x03\x66\x6F\x6F\x09\x03\x06\x0B\x23\x01\x11\x05\x02\x01\x61\x0D\x09\x09\x01\x02\x02\x01\x62\x0F\x0D\x09\x09\x01\x01\x02\x01\x63\x0F\x0D\x09\x09\x02\x01\x02\x01\x64\x0F\x0F\x0F\x10", 0 },
 { 0,	"--- Function calls ---", 0 },
